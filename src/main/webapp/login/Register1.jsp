		...
		<div id="middlecontainer" style="position: relative; top: -20px;">
			<div id="login">
				...
				<div id="container2" style="position: relative; top: -5px;">
					<form action="/login/registerService" method="post">
						<div id="container2-1">
							<p class="myp">学  号:</p>
						</div>
						<div id="container2-2">
						...
						<div id="container2-4">
							<input name="user.email" maxlength="14"
								type="text" class="myinput"
								style="position: relative; top: 40px;">
							<a style="color : #2F4F4F; position: relative; right: 45px; top: 65px; font-weight: bold; font-size: 12px;"
					...
					<div id="container3"
						...
						<button style="padding: 0.7em 2em;"
							...
							type="submit" onClick="??">立即注册</button>
					</div>
				</form>
			</div>
		</div>
